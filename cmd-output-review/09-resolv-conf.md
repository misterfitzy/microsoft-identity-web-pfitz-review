...
## Description
- `/etc/resolv.conf` is a symlink to systemd-resolved's stub resolver
- DNS queries go to local stub resolver at 127.0.0.53
- Search domain is set to `us-east-1.compute.internal` (AWS EC2)
