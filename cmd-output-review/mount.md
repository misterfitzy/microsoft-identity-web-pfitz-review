...
- Root filesystem: `/dev/sda1` (ext4)
- Boot partition: `/dev/sda16` (ext4)
- EFI partition: `/dev/sda15` (vfat)
- Additional data: `/dev/sdb1` mounted on `/mnt` (ext4)
- Various tmpfs and virtual filesystems
