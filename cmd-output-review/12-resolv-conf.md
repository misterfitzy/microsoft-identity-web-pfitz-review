...
`/etc/resolv.conf` is a symlink pointing to `/run/systemd/resolve/stub-resolv.conf`.
...
## Summary
- DNS resolution is managed by **systemd-resolved**
- Local DNS stub resolver at **127.0.0.53**
- Search domain: **us-east-1.compute.internal** (AWS region)
- EDNS0 and DNSSEC trust-ad options enabled
